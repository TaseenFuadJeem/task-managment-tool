...
const Navbar = () => {
    return (
        <nav>
            <div className="navbar bg-secondary lg:px-32 fixed top-0 z-50">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="btn btn-ghost normal-case text-2xl" style={{ fontFamily: 'Russo One' }}>Task Management Tool</Link>
                </div>
